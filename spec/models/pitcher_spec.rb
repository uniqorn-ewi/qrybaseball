...
describe Pitcher do
  ...
  it "top_tenメソッド使用時、上から10番目の投手と同じ勝利数の投手がいない場合" do
    ...
    expect(Pitcher.top_ten(2000))
      .to eq [
        "rokuro","sitiro","hatiro","kuro","juro",
  ...
  it "top_tenメソッド使用時、上から10番目の投手と同じ勝利数の投手がいる場合" do
    ...
    expect(Pitcher.top_ten(2000))
      .to eq [
        "rokuro","sitiro","hatiro","juro","kuro","taro",
        "jiro","saburo","siro","goro","juichiro"
      ]
  end
  ...
  it "top_tenメソッド使用時、指定した年のデータが10件に満たない場合" do
    ...
    expect(Pitcher.top_ten(2000))
      .to eq [
        "hatiro","kuro","juro","taro","jiro","juichiro","jujiro"
      ]
  end
